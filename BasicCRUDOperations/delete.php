...
if(isset($_POST['Ifmd']))
{
    ...
    if($count>0)
    {
    $query="DELETE FROM marks WHERE marks.RegisterNumber='$r' AND marks.SubCode='$r3' AND marks.CatNO=$r2 AND marks.Semester=$r1";
    mysqli_query($connection,$query);
    $_SESSION['suces']="Successfully Deleted";
    }
    else
    {
        $_SESSION['error']="The details of student does not exist in marks database to delete.<br>Cannot delete non existing data";   
    }
}
else{
...
<input type="button" value="Home" class="but1" style="float:right" onclick="location.href='index.php'"><br><br>
    <h1 class="h1d">Delete Marks</h1>
    <p>Delete Marks for student by entering data in the fields</p>
